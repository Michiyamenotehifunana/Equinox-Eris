...
/datum/species
	...
	var/preview_icon			//Equinox edit - furry
	var/icobase_tail = FALSE	//Equinox edit - furry
	var/color_mult = FALSE		//Equinox edit - furry
	var/sprite_compatibility_mode = FALSE	//Equinox edit - furry - enable jank code so that virgo's species dmis don't need to be extensively butchered to work with eris' system. Affects organ_icon.dm stuff.
