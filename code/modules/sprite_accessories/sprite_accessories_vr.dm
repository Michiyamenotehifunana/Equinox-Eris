...
/datum/sprite_accessory/ears
	...
	icon = 'z_modular_equinox/icons/mob/ears_vr.dmi'
	do_colouration = TRUE // Set to 1TRUE to blend (ICON_ADD by default) hair color
...
/datum/sprite_accessory/wing
	name = "You should not see this..."
	icon = 'z_modular_equinox/icons/mob/wings_vr.dmi'
	do_colouration = 0 //Set to 1 to enable coloration using the tail color.

	blend = ICON_ADD // Only appliciable if do_coloration = 1
	var/extra_overlay // Icon state of an additional overlay to blend in.
...
/datum/sprite_accessory/tail
	name = "You should not see this..."
	icon = 'z_modular_equinox/icons/mob/tails_vr.dmi'
	do_colouration = 0 //Set to 1 to enable coloration using the tail color.
...
/datum/sprite_accessory/tail/special
	...
	icon = 'z_modular_equinox/icons/mob/species_tails_vr.dmi'
